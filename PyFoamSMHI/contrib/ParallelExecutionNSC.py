#  ICE Revision: $Id: /local/openfoam/Python/PyFoam/PyFoam/Execution/ParallelExecution.py 6510 2010-04-21T16:13:50.349113Z bgschaid  $ 
...
class LAMMachine(Utilities):
    ...
    def buildMPIrun(self,argv,expandApplication=True):
        ...
        mpirun=["mpprun","--force-mpi=openmpi/1.6.4-build1"]
